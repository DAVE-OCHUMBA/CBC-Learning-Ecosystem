  ...
  await knex('schools').insert([
    {
      ...
      subscription_status: 'active', subscription_tier: 'tier2', total_students: 520,
    ...
    },
    {
      ...
      subscription_status: 'active', subscription_tier: 'tier2', total_students: 380,
      settings: JSON.stringify({ demo: true }),
    },
    {
      ...
      subscription_status: 'active', subscription_tier: 'tier2', total_students: 680,
      settings: JSON.stringify({ demo: true }),
    },
  ]);
